                    ...
                    @foreach($list as $data)
                      ...
                      <tr>
                        <td colspan="6" class="aa-cart-view-bottom">
                          ...
                          <a class="aa-cartbox-checkout aa-primary-btn" href="{{url('/checkout?order_type=Installment')}}"><input class="aa-cart-view-btn" type="button" value="Buy on Installment"></a>
